...
**Licenciatura in Mathematical Sciences** — UNICEN, Argentina &nbsp;·&nbsp; GPA **9.41/10.00** &nbsp;·&nbsp; 5-year degree ≡ B.S. + M.S.

I work on **autoformalization**: translating human-written proofs into machine-checkable Lean 4 code using large language models, and measuring whether those translations preserve logical meaning.
